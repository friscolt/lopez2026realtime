...
# =========================================
model_paths = {
    # Full images ResNet34
    "MIX": f"{DATA_ROOT}/models/resnet34_baseline/resnet34_MIX_seed0_best.pth",
    "SEC": f"{DATA_ROOT}/models/resnet34_baseline/resnet34_SEC_seed0_best.pth",
    "SUR": f"{DATA_ROOT}/models/resnet34_baseline/resnet34_SUR_seed0_best.pth",
}
