...
OUTPUT_CSV = os.path.join(MODEL_DIR,"resnet34_tta_summary.csv")
OUTPUT_JSON = os.path.join(MODEL_DIR,"resnet34_tta_summary.json")
...
for view in VIEWS:
    ...
    for seed in SEEDS:
        ...
        path = f"{MODEL_DIR}/resnet34_{view}_seed{seed}_tta_metrics.json"
