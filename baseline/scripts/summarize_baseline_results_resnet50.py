...
OUTPUT_CSV = os.path.join(MODEL_DIR, "resnet50_summary.csv")
OUTPUT_JSON = os.path.join(MODEL_DIR, "resnet50_summary.json")
...
for view in VIEWS:
    ...
    for seed in SEEDS:
        ...
        path = f"{MODEL_DIR}/resnet50_{view}_seed{seed}_metrics.json"
