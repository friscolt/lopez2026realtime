...
for i,(cls, full_path, roi_path) in enumerate(samples):
    ...
    # reproject CAM to original size
...
save_path = f"{OUTPUT_DIR}/gradcam_full_vs_roi_originalsize.png"
