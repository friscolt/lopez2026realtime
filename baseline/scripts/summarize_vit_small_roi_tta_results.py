...
OUTPUT_CSV=os.path.join(MODEL_DIR,"vit_small_roi_tta_summary.csv")
OUTPUT_JSON=os.path.join(MODEL_DIR,"vit_small_roi_tta_summary.json")
...
for view in VIEWS:
    ...
    for seed in SEEDS:
        ...
        path=f"{MODEL_DIR}/vit_small_roi_{view}_seed{seed}_tta_metrics.json"
