...
MODEL_PATH = f"{MODEL_DIR}/resnet50_roi_{VIEW}_seed{SEED}_best.pth"

CSV_PATH = f"{MODEL_DIR}/resnet50_roi_{VIEW}_seed{SEED}_metrics.csv"
JSON_PATH = f"{MODEL_DIR}/resnet50_roi_{VIEW}_seed{SEED}_metrics.json"
