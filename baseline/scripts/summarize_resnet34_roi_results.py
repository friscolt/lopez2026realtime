...
OUTPUT_CSV = os.path.join(MODEL_DIR, "resnet34_roi_summary.csv")
OUTPUT_JSON = os.path.join(MODEL_DIR, "resnet34_roi_summary.json")
...
for view in VIEWS:
    ...
    for seed in SEEDS:
        ...
        path = f"{MODEL_DIR}/resnet34_roi_{view}_seed{seed}_metrics.json"
