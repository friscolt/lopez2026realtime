...
OUTPUT_CSV = os.path.join(MODEL_DIR,"baseline_summary.csv")
OUTPUT_JSON = os.path.join(MODEL_DIR,"baseline_summary.json")
...
for view in VIEWS:
    ...
    for seed in SEEDS:
        ...
        path = f"{MODEL_DIR}/resnet34_{view}_seed{seed}_metrics.json"
