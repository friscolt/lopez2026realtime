...
MODEL_PATH = f"{MODEL_DIR}/vit_small_{VIEW}_seed{SEED}_best.pth"

CSV_PATH = f"{MODEL_DIR}/vit_small_{VIEW}_seed{SEED}_metrics.csv"
JSON_PATH = f"{MODEL_DIR}/vit_small_{VIEW}_seed{SEED}_metrics.json"
