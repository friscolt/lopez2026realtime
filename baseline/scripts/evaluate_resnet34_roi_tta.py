...
OUTPUT_DIR=f"{DATA_ROOT}/models/resnet34_roi_baseline"

CSV_PATH=f"{OUTPUT_DIR}/resnet34_roi_{VIEW}_seed{SEED}_tta_metrics.csv"
JSON_PATH=f"{OUTPUT_DIR}/resnet34_roi_{VIEW}_seed{SEED}_tta_metrics.json"
